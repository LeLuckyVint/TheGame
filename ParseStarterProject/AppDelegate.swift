...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        UINavigationBar.appearance().barTintColor = UIColor(red: 0x7B, green: 0x1f, blue: 0xa2, alpha: 1)
        
        Parse.setApplicationId("0Oe86kU55EKkZ9OxuhAp3DGHpOtOvTr7JaB49rtA",
            clientKey: "lbI8KiFDwN59igAaI1S8NoBztDxTvoZENRM9H4eY")
